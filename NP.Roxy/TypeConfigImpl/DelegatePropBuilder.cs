...
{
    public class DelegatePropBuilder : IMemberCodeBuilder<IPropertySymbol>
    {
        public static DelegatePropBuilder TheDelegatePropBuilder { get; } =
            new DelegatePropBuilder();
